...
| G03 | Define a person's resource access — **OrgUnit scope basis owner-confirmed, details incomplete** | Owner decision, 2026-09-17: access is scoped by an OrgUnit or a collection of OrgUnits. See the [resource-access decision](workflows/platform-access.md#resource-access--2026-09-17). This does not establish a school entity or school-creation workflow. | Define descendant access, exclusions, later OrgUnit changes, collection reuse, and the relationship between roles and scopes. Group access and platform-wide permissions remain separate decisions. A whole-Workspace option and a collection-management page are not established by this answer. |
