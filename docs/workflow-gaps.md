...
| G02 | Assign and edit permissions — **roles and access assignments owner-confirmed, details incomplete** | Owner decisions, 2026-09-17: a role is a named reusable collection of permissions. An access assignment associates a platform user, a role, and an OrgUnit collection. See the [model and example](workflows/platform-access.md#roles-orgunit-collections-and-access-assignments--2026-09-17). Individual permission exceptions remain outside the agreed model. | Define the complete permission catalog, built-in roles, multiple assignments, change effects, delegation authority, and effective-access explanations. Define controls across the separate Settings concerns. Resource-scope details remain G03. Figma composition remains missing. |
