...
| --- | --- | --- | --- |
| G01 | Add a person to Campus Commander — **eligibility owner-confirmed, invitation sequence unresolved** | Owner decision, 2026-09-17, recorded verbatim in the [platform-access workflow](workflows/platform-access.md#who-administrators-can-invite--2026-09-17). Administrators can select directory accounts and invite people outside the Workspace. The platform is invite-only. Access requests are prohibited. | Define external-person entry, invitation delivery, recipient authentication, and activation. The implemented link/redemption/second-confirmation sequence remains disputed. The current decision replaces conflicting interpretations of historical decision 17.7. |
