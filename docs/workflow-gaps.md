...
| G02 | Assign and edit permissions — **reusable roles owner-confirmed, details incomplete** | Owner decision, 2026-09-17: define permissions in reusable roles and assign roles to platform users. Individual permission exceptions are outside the agreed model. See the [permission decision](workflows/platform-access.md#permission-assignment--2026-09-17). Platform Users and Platform Roles and Permissions remain separate pages under Settings. Historical R12 presets do not establish the role catalog. | Define role names, permission choices, role multiplicity, role-change behavior, delegation authority, and effective-access explanations. Define assignment controls across the separate concerns. Resource access remains G03. Figma composition remains missing. |
| G03 | Define a person's resource access — **OrgUnit scopes and descendant control owner-confirmed, details incomplete** | Owner decision, 2026-09-17: access is scoped by an OrgUnit or a collection of OrgUnits. See the [resource-access decision](workflows/platform-access.md#resource-access--2026-09-17). Each selected OrgUnit has an administrator-controlled [Include descendants option](workflows/platform-access.md#include-descendants--2026-09-17). This does not establish a school entity or school-creation workflow. | Define the option's initial state, overlapping selections, exclusions, later OrgUnit changes, collection reuse, and the relationship between roles and scopes. Group access and platform-wide permissions remain separate decisions. A whole-Workspace option and a collection-management page are not established by this answer. |
...
| School access became school creation and a standalone page. | Technical review C12/R12 versus CC-52's forms and route. | The owner confirmed [OrgUnit-based resource access](workflows/platform-access.md#resource-access--2026-09-17). School creation remains disputed and outside this workflow. OrgUnit collections do not establish a new management page. |
