...
| --- | --- | --- | --- |
| G01 | Add a person to Campus Commander — **eligibility, sign-in methods, email delivery, and activation owner-confirmed; details incomplete** | Owner decision, 2026-09-17, recorded verbatim in the [platform-access workflow](workflows/platform-access.md#who-administrators-can-invite--2026-09-17). Administrators can select directory accounts and invite people outside the Workspace. The platform is invite-only. Access requests are prohibited. The owner confirmed [external invitees without Google accounts](workflows/platform-access.md#external-invitees-without-google-accounts--2026-09-17). External invitees can use [configured identity providers or email sign-in codes](workflows/platform-access.md#external-sign-in-methods--2026-09-17). Administrators [select allowed methods per platform user](workflows/platform-access.md#allowed-sign-in-methods-per-platform-user--2026-09-17). The owner selected [email delivery from Campus Commander](workflows/platform-access.md#invitation-delivery--2026-09-17). | Define external-person entry, identity matching, sign-in method defaults and exact controls, provider and email configuration, and delivery failure handling. Manual copy-link delivery is outside the agreed workflow. Access activates immediately after valid invitation acceptance and identity verification, without a second administrator confirmation. See the [activation decision](workflows/platform-access.md#access-activation--2026-09-17). The current decision replaces conflicting interpretations of historical decision 17.7. |
| G02 | Assign and edit permissions — **granular permissions, roles, and multiple assignments owner-confirmed, details incomplete** | Owner decisions, 2026-09-17: a role is a named reusable collection of permissions. An access assignment associates a platform user, a role, and an OrgUnit collection. See the [model and example](workflows/platform-access.md#roles-orgunit-collections-and-access-assignments--2026-09-17). The owner confirmed [multiple assignments per platform user](workflows/platform-access.md#multiple-access-assignments--2026-09-17), preserving each role-and-collection pairing. Overlapping assignments [combine permissions: most permissive wins](workflows/platform-access.md#overlapping-access-assignments--2026-09-17). Saved role and collection changes [automatically apply to existing assignments](workflows/platform-access.md#saved-role-and-collection-changes--2026-09-17). The owner confirmed [granular permission labels](workflows/platform-access.md#granular-permissions--2026-09-17) for device and Google-user read, write, bulk actions, device deprovisioning, and user schema management. The owner clarified Device Deprovision and confirmed that the list is non-exhaustive. The owner confirmed the [Bulk Actions dropdown and action-permission dependency](workflows/platform-access.md#bulk-actions-permission--2026-09-17). Individual permission exceptions remain outside the agreed model. | Define remaining action coverage and dependencies, schema-management boundaries, the remaining catalog, built-in roles, delegation authority, and effective-access explanations. Define exact controls within the confirmed separate Settings pages. Access Assignments has its own grid page, not a Platform Users tab. Resource-scope details remain G03. Figma composition remains missing. |
| G03 | Define a person's resource access — **named OrgUnit collections and assignments owner-confirmed, details incomplete** | Owner decisions, 2026-09-17: named reusable OrgUnit collections define resource scope and represent schools for access administration. Each selected OrgUnit has an [Include descendants option](workflows/platform-access.md#include-descendants--2026-09-17). An assignment combines the collection with a role and platform user. See the [model and example](workflows/platform-access.md#roles-orgunit-collections-and-access-assignments--2026-09-17). | Overlapping assignments follow the [most-permissive rule](workflows/platform-access.md#overlapping-access-assignments--2026-09-17). Saved collection edits [automatically update existing assignments](workflows/platform-access.md#saved-role-and-collection-changes--2026-09-17). Enabled descendant scopes [follow the current Google hierarchy](workflows/platform-access.md#descendant-hierarchy-changes--2026-09-17), including new or moved-in descendants and excluding moved-out descendants. Define descendant defaults, exclusions, and exact controls within the separate OrgUnit Collections page under Settings. Group access and platform-wide permissions remain separate decisions. A separate school entity and a whole-Workspace option are not established. |
